...
<input type="text" name="search" id="search" /> <button onclick="return searchValidate()">go</button>
 ...
 <c:if test="${not empty sessionScope.isAdmin}" >
  ...
  <div class="form">
  <h2 class="message">Please answer the Below Another Security Questions</h2>
    <form class="login-form" method="post" action="resetpasswordsec" name="myForm">
     ${user.secquestion2} <input type="text" name ="sa2" placeholder="" name="sa2"  /><br />
