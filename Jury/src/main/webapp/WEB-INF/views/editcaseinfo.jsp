...
<h3>Edit Case Info</h3>
    <form class="login-form" method="post" id="casequestions" action="updatecaseinfo">
 	Q.<textarea name="q" id="q" rows="4" cols="50">${scd.casequestions}</textarea>
	A.<textarea name="a" rows="4" id="a" cols="50">${scd.verdict}</textarea><br><br>
	<input type="hidden" name="id" value="${scd.id}" />
	<input type="hidden" name="subcasetype" value="${scd.subcase}" />
